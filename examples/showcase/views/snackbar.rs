        ...
        .with_children(|section| {
            ...
            section.spawn(Node {
                ...
                options.spawn(Node {
                    ...
                    let chip_for_color = MaterialChip::filter(toggle_label).with_selected(false);
                    let label_color = chip_for_color.label_color(theme);

                    row.spawn((
                        SnackbarActionToggle,
                        Interaction::None,
                        ChipBuilder::filter(toggle_label).selected(false).build(theme),
                    ))
                    .with_children(|chip| {
                        chip.spawn((
                            ChipLabel,
            ...
            section.spawn(Node {
                ...
                let trigger_button = MaterialButton::new(trigger_label).with_variant(ButtonVariant::Filled);
                let trigger_text_color = trigger_button.text_color(theme);

                row.spawn((
                    SnackbarTrigger,
                    Interaction::None,
                    MaterialButtonBuilder::new(trigger_label).filled().build(theme),
                ))
                .with_children(|btn| {
                    btn.spawn((
                        ButtonLabel,
