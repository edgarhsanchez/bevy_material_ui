...
use bevy_material_ui::icons::{ICON_MORE_VERT, ICON_EXPAND_MORE};
use bevy_material_ui::list::{ListItemBody, ListItemHeadline, ListItemSupportingText, ListItemBuilder};

use crate::showcase::common::*;

/// Spawn the menus section content
pub fn spawn_menus_section(parent: &mut ChildSpawnerCommands, theme: &MaterialTheme, icon_font: Handle<Font>) {
    parent
        .spawn(Node {
        ...
        .with_children(|section| {
            ...
            section.spawn(Node {
                ...
                // Menu trigger button
                let trigger_button = MaterialButton::new("Options").with_variant(ButtonVariant::Outlined);
...
fn spawn_menu_item(parent: &mut ChildSpawnerCommands, theme: &MaterialTheme, label: &str, shortcut: &str, is_destructive: bool) {
    let headline_color = if is_destructive { theme.error } else { theme.on_surface };
