...
pub fn spawn_tooltip_section(parent: &mut ChildSpawnerCommands, theme: &MaterialTheme, _icon_font: Handle<Font>) {
    parent
        .spawn(Node {
        ...
        .with_children(|section| {
            ...
            section.spawn(Node {
                ...
                let demo_button = MaterialButton::new(demo_label).with_variant(ButtonVariant::Filled);
